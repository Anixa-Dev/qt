...
const SuccessDialog = ({
  ...
  const [ collapseState, setCollapseState ] = useState({ embed: false, token: true })
  ...
  return (
    ...
    >
      <CustomTypography
        value={ `Congratulations! You have successfully set up your ${ tokenData?.collectible_type } 🎉` }
      ...
      <div className={ classes.dialogQueryContainer }>
        ...
        <div className={ classes.socialIconContainer }>
          ...
          <TwitterShareButton
            url={ `${ config.APP_BASE_URL }/token/${ tokenData?.token_id }` }
